...

{
    ...
    public partial class TestRes1b : System.Web.UI.Page

    {
...

        {
            ...
            DropDownList1.Items.Insert(0, new ListItem("Select Stream"));
...

        {
            ...
            SqlDataAdapter adp = new SqlDataAdapter("Select * from teststud where Stream='" + DropDownList1.SelectedValue + "'", con);
...

        {
            ...
            SqlCommand cmd = new SqlCommand("Select Rollno from teststud where Stdname='" + DropDownList2.SelectedValue + "'", con);
...

        {
            ...
            SqlCommand cmd = new SqlCommand("Insert into testSem1(Rollno,StudentName,StreamName,Core1,Core2,AECC1,GE1,Total,Percentage) values('" + TextBox1.Text + "','" + TextBox2.Text + "','" + TextBox3.Text + "','" + TextBox4.Text + "','" + TextBox5.Text + "','" + TextBox6.Text + "','" + TextBox7.Text + "','" + TextBox8.Text + "','" + TextBox9.Text + "')", con);
...

        {
            ...
            SqlCommand cmd = new SqlCommand("select * from testSem1 where Rollno=@Roll", conn);
