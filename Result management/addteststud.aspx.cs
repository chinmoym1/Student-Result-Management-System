...
{
    public partial class addteststud : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            SqlConnection conn = new SqlConnection(@"Data Source=LAPTOP-EKEB5SP5\SQLEXPRESS; Initial Catalog=SRMS; Integrated Security=true");
            using (SqlCommand cmd = new SqlCommand("Insert into teststud(Stdname,Gender,DOB,Stream) values(@Name,@G,@DOB,@stream)"))
            {
