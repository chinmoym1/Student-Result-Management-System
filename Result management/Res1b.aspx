<%@ Page Title="" Language="C#" MasterPageFile="~/Masterpage.Master" AutoEventWireup="true" CodeBehind="Res1b.aspx.cs" Inherits="Result_management.Res1b" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <%--<asp:Panel ID="Panel1" runat="server"></asp:Panel>
                <table>
                    <tr>
                        <td>
                            <asp:Label ID="Label3" runat="server" Text="Core-I:Programming Fundamentals using C/C++" margin="20px"></asp:Label>
                    ...
                    <tr>
                        ...
                        </td><asp:Label ID="Label4" runat="server" Text="Core-II:Computer System Architecture"></asp:Label>
                            <asp:TextBox ID="TextBox2" runat="server"></asp:TextBox>
                    </tr>
                    <tr>
                    <td>
                        <asp:Label ID="Label5" runat="server" Text="AECC-1:Environmental Science"></asp:Label>
                            <asp:TextBox ID="TextBox3" runat="server"></asp:TextBox>
                    </td>
                       </tr>
                    <tr>
                        <td >
                           <asp:Label ID="Label6" runat="server" Text="GE-1:General Elective"></asp:Label>
